...
import jo.d2k.data.logic.report.ClusterReport;
...
public class HandlerReportCluster extends AbstractHandler
{

    @Override
    public Object execute(ExecutionEvent ev) throws ExecutionException
    {
        String output = GenericAction.getSaveFile(HandlerReportCluster.class, null, "HTML File", "*.html");
        if (output == null)
            return null;
        File outFile = new File(output);
        String html = ClusterReport.generateReport(ChViewVisualizationLogic.mPreferences);
        try
        {
