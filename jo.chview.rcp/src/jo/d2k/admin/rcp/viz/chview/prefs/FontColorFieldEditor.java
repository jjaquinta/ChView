 ...
 */
public class FontColorFieldEditor extends FieldEditor {
     ...
     */
    protected FontColorFieldEditor() {
    }
     ...
     */
    public FontColorFieldEditor(String name, String labelText,
     ...
     * @param parent the parent of the field editor's control
     */
    public FontColorFieldEditor(String name, String labelText, Composite parent) {
    ...
    public void setChosenColor(RGB chosenColor)
    {
