...
//        if (objClass.isArray())
//            DebugUtils.trace("Array! "+objClass.getCanonicalName());
    ...
    public static Node toXML(Node parent, Object obj, Map<Object,Object> map)
    {
        if (!isPolymorphic(obj))
        {
            ...
            {            
                ...
                //DebugUtils.trace("ref:"+ref+"<-"+obj.getClass().getName()+" "+parent.getNodeName());
                return n;
            }
        }
        Integer ref;
        ...
        //DebugUtils.trace(ref+"->"+obj+" ("+obj.getClass().getName()+")");
    ...
    public static Object fromXML(Node bean, Map<Object,Object> map, ClassLoader loader)
    {
        ...
        map.put(key, ret);
        //DebugUtils.trace(key+"->"+ret.toString());
        return ret;
    }
