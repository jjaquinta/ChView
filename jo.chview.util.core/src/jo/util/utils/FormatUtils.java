...
public class FormatUtils
{
    ...
    public static String formatDateVersion(long ticks)
    {
        Calendar c = Calendar.getInstance();
        c.setTimeInMillis(ticks);
        StringBuffer sb = new StringBuffer();
        sb.append(zeroPrefix(c.get(Calendar.YEAR), 4));
        sb.append(zeroPrefix(c.get(Calendar.MONTH) + 1, 2));
        sb.append(zeroPrefix(c.get(Calendar.DAY_OF_MONTH), 2));
        return sb.toString();
    }
    ...
    {
        String ret = CURRENCY_SYMBOL + formatCommaNumber(dosh);
        return ret;
    }
    ...
    public static String formatDMS(double v)
    {
        int d = (int)Math.floor(v);
        v = (v - d)*60;
        int m = (int)Math.floor(v);
        v = (v - m)*60;
        double s = v;
        return d+"\u00b0 "+m+"\u2032 "+formatDouble(s, 2)+"\u2033";
    }
    
    public static String formatHMS(double v)
    {
        ...
        v = (v - m)*60;
        double s = v;
        return h+"h "+m+"m "+formatDouble(s, 2)+"s";
    }
}
