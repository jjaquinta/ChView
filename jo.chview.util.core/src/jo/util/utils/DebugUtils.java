...
public class DebugUtils
{
    ...
    public static List<LogEngine> mLoggers = new ArrayList<LogEngine>();
    static
    {
        mLoggers.add(new CommandLineLogger());
    }
	
	public static void log(int severity, String msg, Throwable exception)
	{
        for (LogEngine logger : mLoggers)
            logger.log(severity, msg, exception);
	}
