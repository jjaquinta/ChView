...
public class Points3DLogic {
	...
	public static Point3D getCenter(Point3D p, List<Point3D> points)
	{
	...
	public static void sortByAngleAround(final Point3D center, final Point3D closest,
		...
		DebugUtils.trace("Sorted points: (closest="+closest+", center="+center+", normal="+normal+")");
		for (Point3D p : points)
		{
			double a;
			if (normal != null)
