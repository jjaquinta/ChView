...
{
    /*
     * $Log$ Revision 1.1 2002/08/22 20:01:16 egonw Lots of new files. Amongst
     * which the source code of vecmath.jar. The latter has been changed to
     * compile with gcj-3.0.4. Actually, CDK does now compile, i.e. at least the
     * classes mentioned in core.classes and extra.classes. *And* a binary
     * executable can get generated that works!
     * 
     * # Revision 1.1 1999/11/25 10:29:35 hiranabe # Initial revision # #
     * Revision 1.1 1999/11/25 10:29:35 hiranabe # Initial revision #
     */
     ...
     * 
     */
    private static final long serialVersionUID = 3936853393140138892L;
    ...
    /**
     * Sets the value of this tuple to the specified coordinates int the array
     * of length 3.
     * 
     * @param t
     ...
     * different Tuple3i objects with identical data values (ie, returns true
     * for equals(Tuple3i) ) will return the same hash number. Two vectors with
    ...
    /**
     * Returns true if all of the data members of Tuple3i t1 are equal to the
